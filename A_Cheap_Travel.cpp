...
// string to number conversion : string s = "12345"; stringstream geek(s); int x = 0; geek >> x;
//ASCII Values : {a : 097 - z : 122} || {A : 065 - Z : 090} || {0 : 48 - 9 : 57}
...
void stndr(){
    ...
    if(b<a){
        ...
        ll mRide = (n/m)*b;
        ll sRide = (n - ((n/m) * (m)))*a;
        ll tRideCost = mRide + sRide;
        cout<<min(n*a , tRideCost);
    }
}
